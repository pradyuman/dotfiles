...
(def-doom-theme
  ...
  ((bg         '("#171717" nil       nil            )) ;; badger-bg
   ...
   (base5      '("#756784" "#6c6c6c" "brightblack"  )) ;;
   (base6      '("#7a7e7e" "#808080" "brightblack"  )) ;;
   (base7      '("#9ca0a4" "#979797" "brightblack"  )) ;;
   (base8      '("#dfdfdf" "#dfdfdf" "white"        )) ;;
   (fg         '("#bbbbbb" "#bbbbbb" "white"        )) ;; zenwritten-foreground
   ...
   (dark-violet    '("#7d7395")) ;; tuned badger-dark-violet
  ...
  ((font-lock-property-name-face
    :foreground (doom-blend keywords fg 0.6)
    :weight 'normal)
   ...
   (org-tag :foreground orange :weight 'bold :strike-through nil)
   (org-todo :foreground red)
   (org-verbatim :inherit 'org-code)
   (org-warning :foreground magenta :weight 'bold)
